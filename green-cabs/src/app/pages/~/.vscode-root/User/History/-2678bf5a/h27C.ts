...
export class AnalogWelcomeComponent {
  riderFeatures = [
    { icon: 'star', title: 'Easy Booking', description: 'Book rides effortlessly.' },
    { icon: 'directions_car', title: 'Variety of Cars', description: 'Choose the car that suits your needs.' },
