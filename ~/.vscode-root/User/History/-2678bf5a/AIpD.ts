...
@Component({
  ...
  <div class="max-w-6xl mx-auto text-center">
    ...
    <p class="text-lg mb-6">What sets Green Cabs apart from the competition?</p>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="bg-green-100 p-6 rounded-lg hover:shadow-2xl hover:scale-105 transition-all duration-300">
