...
@Component({
  ...
  imports: [CommonModule, MatButtonModule, MatIconModule, MatCardModule, 
            MatSidenavModule, MatListModule, MatToolbarModule, RouterLink, FooterPage, Swiper],
  template: `
    <mat-sidenav-container class="sidenav-container">
      ...
      <! -- Hero Section -->
      <section class="hero-section min-h-screen text-white">
          ...
          <div class="hero-content text-center p-6 bg-opacity-90 bg-green-800 rounded-lg shadow-2xl">
            <h1 class="hero-heading text-5xl font-bold mb-4 mat-display-1 text-shadow-xl">
              Sustainable, Smart, and Reliable Transportation Solutions in Rwanda
            </h1>
            <p class="hero-subheading text-lg mb-6">
              From taxis to car rentals and sales, we’ve got you covered with eco-friendly options and outstanding service.
            </p>
            <div class="hero-buttons flex justify-center space-x-4">
              <button mat-raised-button color="primary" class="hero-btn px-6 py-3 hover:bg-green-700 hover:scale-105 shadow-lg">
                Book a Ride
              </button>
              <button mat-raised-button color="accent" class="hero-btn px-6 py-3 hover:bg-green-500 hover:scale-105 shadow-lg">
                View Cars for Sale
              </button>
              <button mat-raised-button color="accent" class="hero-btn px-6 py-3 hover:bg-green-500 hover:scale-105 shadow-lg">
                Rent a Car
   ...
   <!-- Overview of Services -->
      <section class="our-services-section py-16 px-8 bg-white text-green-600">
