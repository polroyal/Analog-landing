  ...
  <!-- Features Section -->
   ...
   <!-- Competitive Edge Section -->
    ...
    <!-- App Screenshots Section -->
      ...
      <section class="py-16 px-8 bg-white text-green-600">
        <h2 class="text-3xl font-bold mb-4">Making Cab Service Experience Smooth</h2>
        <swiper [slidesPerView]="1" [spaceBetween]="10" pagination="true">
          <ng-template swiperSlide *ngFor="let screenshot of screenshots">
            <mat-card>
