    ...
    <section class="py-16 px-8 bg-white text-green-600">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div *ngFor="let riderFeature of riderFeatures" class="bg-gray-50 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            <mat-icon class="text-green-600 text-4xl mb-4">{{ riderFeature.icon }}</mat-icon>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div *ngFor="let driverFeature of driverFeatures" class="bg-gray-50 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            <mat-icon class="text-green-600 text-4xl mb-4">{{ driverFeature.icon }}</mat-icon>
...
<section class="py-16 px-8 bg-white text-green-600">
  <div class="max-w-6xl mx-auto">
    <h2 class="text-3xl font-bold mb-8 text-center mat-headline">App Screenshots</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
      <img src="/assets/screenshot1.png" alt="Ride Booking" class="rounded-lg shadow-md transition-transform duration-300 hover:scale-105">
      <img src="/assets/screenshot2.png" alt="Tracking" class="rounded-lg shadow-md transition-transform duration-300 hover:scale-105">
      <img src="/assets/screenshot3.png" alt="Payments" class="rounded-lg shadow-md transition-transform duration-300 hover:scale-105">
      <img src="/assets/screenshot4.png" alt="Driver Ratings" class="rounded-lg shadow-md transition-transform duration-300 hover:scale-105">
    </div>
  </div>
</section>
...
<section class="py-16 px-8 bg-green-600 text-white text-center">
  ...
  <div class="flex justify-center space-x-4">
    <a href="https://play.google.com/store" target="_blank">
      <img src="/assets/google-play.png" alt="Download on Google Play" class="h-12">
    </a>
    <a href="https://www.apple.com/app-store/" target="_blank">
      <img src="/assets/app-store.png" alt="Download on the App Store" class="h-12">
    </a>
    <button mat-raised-button color="accent">Join as a Driver</button>
  </div>
</section>
