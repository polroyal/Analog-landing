...
import Swiper, { Pagination } from 'swiper'; // Import Swiper and the Pagination module
import 'swiper/css'; // Import core Swiper styles
import 'swiper/css/pagination'; // Import Pagination styles specifically
          ...
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <mat-card> <!-- First Screenshot -->
                  <img src="public/cabme-customer-3.png" alt="Screenshot 1" />
                </mat-card>
              </div>
              <div class="swiper-slide">
                <mat-card> <!-- Second Screenshot -->
                  <img src="public/cabme-customer-4.png" alt="Screenshot 2" />
                </mat-card>
              </div>
              <div class="swiper-slide">
                <mat-card> <!-- Third Screenshot -->
                  <img src="public/cabme-driver-6.png" alt="Screenshot 3" />
                </mat-card>
              </div>
            </div>
            <!-- Pagination -->
...
export class AnalogWelcomeComponent implements AfterViewInit {

     // Initialize Swiper in the lifecycle hook
     ngAfterViewInit() {
      const swiper = new Swiper('.swiper-container', {
        modules: [Pagination], // Make sure the Pagination module is loaded
        pagination: {
          el: '.swiper-pagination', // Define the pagination element
