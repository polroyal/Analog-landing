...
import { RouterLink, RouterOutlet } from '@angular/router' with { analog: 'impo'};
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatButtonModule, MatIconModule, MatCardModule, MatSidenavModule, MatListModule, MatToolbarModule, RouterLink],
  template: `
