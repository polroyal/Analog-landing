  ...
  <!-- Features Section -->
   ...
   <!-- Competitive Edge Section -->
    ...
    <!-- App Screenshots Section -->
      // <section id="app-screenshots" class="py-16 bg-gray-50">
      <section class="py-16 px-8 bg-white text-green-600">
        <div class="container mx-auto text-center">
          // <h2 class="text-4xl font-bold mb-10 text-gray-800"></h2>
          <h2 class="text-3xl font-bold mb-12 mat-headline">Making Cab Service Experience Smooth</h2>
          <swiper
            [spaceBetween]="30"
            [loop]="true"
            [autoplay]="{ delay: 3000 }"
          ...
          >
            <ng-template swiperSlide>
              <img src="public/cabme-customer-3.png " alt="App Screenshot 1" class="w-full rounded-lg shadow-md" />
            </ng-template>
            <ng-template swiperSlide>
              <img src="public/cabme-customer-4.png" alt="App Screenshot 2" class="w-full rounded-lg shadow-md" />
            </ng-template>
            <ng-template swiperSlide>
              <img src="public/cabme-driver-6.png" alt="App Screenshot 3" class="w-full rounded-lg shadow-md" />
            </ng-template>
