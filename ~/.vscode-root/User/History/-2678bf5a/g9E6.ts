            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <mat-card> <!-- First Screenshot -->
                  <img src="assets/screenshots/screenshot1.png" alt="Screenshot 1" />
                </mat-card>
              </div>
              <div class="swiper-slide">
                <mat-card> <!-- Second Screenshot -->
                  <img src="assets/screenshots/screenshot2.png" alt="Screenshot 2" />
                </mat-card>
              </div>
              <div class="swiper-slide">
                <mat-card> <!-- Third Screenshot -->
                  <img src="assets/screenshots/screenshot3.png" alt="Screenshot 3" />
                </mat-card>
              </div>
            </div>
            <!-- Pagination -->
  ...
  screenshots = [
   ...
   ngAfterViewInit() {
    new Swiper('.swiper-container', {
      ...
      pagination: {
        el: '.swiper-pagination', // Attach Pagination
