...
import { MatSidenavModule } from '@angular/material/sidenav'; // Angular Material Sidenav Module
import { MatListModule } from '@angular/material/list'; // Angular Material List for menu items
import { MatToolbarModule } from '@angular/material/toolbar'; // Toolbar for the header
